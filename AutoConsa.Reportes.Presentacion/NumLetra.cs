...
namespace AutoConsa.Reportes.Presentacion
{
    class NumLetra
    {
        ...
        private static readonly String[] DECENAS = { "diez ", "once ", "doce ", "trece ", "catorce ", "quince ", "dieciseis ", "diecisiete ", "dieciocho ", "diecinueve", "veinte ", "treinta ", "cuarenta ", "cincuenta ", "sesenta ", "setenta ", "ochenta ", "noventa " };
        private static readonly String[] CENTENAS = { "", "ciento ", "doscientos ", "trecientos ", "cuatrocientos ", "quinientos ", "seiscientos ", "setecientos ", "ochocientos ", "novecientos " };

        private static Regex r;

        internal static String Convertir(String numero, bool mayusculas)
        {
            ...
            if (mc.Count > 0)
            {
                ...
                parte_decimal = "con " + Num[1] + "/100 dólares.";
